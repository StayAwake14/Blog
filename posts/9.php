...
END;
	...
	<br/>
		...
		<?php
			...
			$zap  = "SELECT * FROM posts WHERE id=9";
			
		if($wykonaj = $connect->query($zap))
			{
				$wiersze = $wykonaj->rowCount();
			
					$zap2  = "SELECT * FROM posts WHERE id=9";
					...
					if($wykonaj2 = $connect->query($zap2))
					{
						...
						<div id="main">
							...
							<h1>
									...
									<div class="fb-comments" data-width="400" data-href="https://www.facebook.com/gamerscloud?=post9" data-numposts="5"></div>
